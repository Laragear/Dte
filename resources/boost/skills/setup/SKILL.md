...
description: "Use this skill to setup the library the first time after install; skip when the project already has a digital certificate at `storage/private/app/dte/*`".
license: MIT
metadata:
  author: laragear
---
