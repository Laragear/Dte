...
class SiiDte extends Model
{
    ...
    /**
     * Create a fluent builder hydrated with this document's payload data. Call `update()` to resend this document.
     */
    ...
    /**
     * Retry this document through a callback that modifies the hydrated builder, saved once the callback ends.
     */
    ...
    {
        $clone = $this->replicate(array_merge($except, [
            'sii_caf_id',
            'sii_dte_envelope_id',
            'folio',
            'status',
    ...
    /**
     * Annul this document folio through its CAF, reporting the annulment to the SII.
     *
     * The document's folio is normally below the CAF pointer, so the allocation guard is skipped.
     */
    ...
    /**
     * Check if this document folio was annulled.
     */
